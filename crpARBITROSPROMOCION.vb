...
Public Class crpARBITROSPROMOCION
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "crpARBITROSPROMOCION.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "proyecto_delta.crpARBITROSPROMOCION.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_anhopromocion() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcrpARBITROSPROMOCION
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpARBITROSPROMOCION = New crpARBITROSPROMOCION()
        rpt.Site = Me.Site
        Return rpt
    End Function
