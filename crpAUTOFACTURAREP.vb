...
Public Class crpAUTOFACTURAREP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "proyecto_delta.crpAUTOFACTURAREP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpAUTOFACTURAREP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpAUTOFACTURAREP = New crpAUTOFACTURAREP()
        rpt.Site = Me.Site
        Return rpt
    End Function
