...
#End Region
    ...
    Private Sub btnimprimir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnimprimir.Click
        ...
        Try
            ...
            With report
                .Load(wkdirectorio & "\crpRECIBOREP.rpt")
            ...
            With frmREPORT
                ...
                .crvimpre.SelectionFormula = "{recibo.recfecha} >= Date(" & auxanho & ", " & auxmes & ", " & auxdia & ") and {recibo.recfecha} <= Date(" & auxanho1 & ", " & auxmes1 & ", " & auxdia1 & ")"
                .Show()
            End With
            CerrarConexion()
