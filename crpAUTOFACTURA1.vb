...
Public Class crpAUTOFACTURA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "proyecto_delta.crpAUTOFACTURA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpAUTOFACTURA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpAUTOFACTURA = New crpAUTOFACTURA()
        rpt.Site = Me.Site
        Return rpt
    End Function
