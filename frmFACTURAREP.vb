...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Label17.Text = "REPORTE DE FACTURA"
        ...
        Me.Name = "frmFACTURAREP"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "DELTA - Módulo de Reporte de Factura"
...
#End Region
    ...
    Private Sub btnimprimir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnimprimir.Click
        ...
        Try
            ...
            With report
                .Load(wkdirectorio & "\crpFACTURAREP.rpt")
            ...
            With frmREPORT
                ...
                .crvimpre.SelectionFormula = "{factura.facfecha} >= Date(" & auxanho & ", " & auxmes & ", " & auxdia & ") and {factura.facfecha} <= Date(" & auxanho1 & ", " & auxmes1 & ", " & auxdia1 & ")"
                .Show()
            End With
            CerrarConexion()
