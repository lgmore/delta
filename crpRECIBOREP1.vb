...
Public Class crpRECIBOREP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "proyecto_delta.crpRECIBOREP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpRECIBOREP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpRECIBOREP = New crpRECIBOREP()
        rpt.Site = Me.Site
        Return rpt
    End Function
