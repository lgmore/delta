...
Public Class crpFACTURAREP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "proyecto_delta.crpFACTURAREP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpFACTURAREP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpFACTURAREP = New crpFACTURAREP()
        rpt.Site = Me.Site
        Return rpt
    End Function
