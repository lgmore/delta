...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.GroupBox1.Text = "Panel de Datos de Autofactura"
        '
        'txttelefono
        '
        ...
        Me.txttelefono.Location = New System.Drawing.Point(120, 170)
        ...
        Me.txtdireccion.Location = New System.Drawing.Point(120, 143)
        ...
        Me.txtbeneficiario.Location = New System.Drawing.Point(120, 116)
        ...
        Me.txtRUC.Location = New System.Drawing.Point(120, 89)
        ...
        Me.btnAYUDA.Location = New System.Drawing.Point(236, 29)
        ...
        Me.datfecha.Location = New System.Drawing.Point(120, 59)
        ...
        Me.txtnumero.Location = New System.Drawing.Point(120, 31)
        ...
        Me.txtcheque.Location = New System.Drawing.Point(553, 232)
        Me.txtcheque.MaxLength = 24
        Me.txtcheque.Name = "txtcheque"
        Me.txtcheque.Size = New System.Drawing.Size(117, 26)
        Me.txtcheque.TabIndex = 70
        Me.txtcheque.Text = ""
        '
        'txtbanco
        '
        ...
        Me.txtbanco.Location = New System.Drawing.Point(320, 230)
        Me.txtbanco.MaxLength = 14
        Me.txtbanco.Name = "txtbanco"
        Me.txtbanco.Size = New System.Drawing.Size(128, 26)
        Me.txtbanco.TabIndex = 69
        Me.txtbanco.Text = ""
        '
        'Label15
        '
        ...
        Me.Label15.Location = New System.Drawing.Point(454, 230)
        ...
        Me.Label14.Location = New System.Drawing.Point(263, 231)
        ...
        Me.txtFUENTE.Location = New System.Drawing.Point(143, 229)
        Me.txtFUENTE.Name = "txtFUENTE"
        Me.txtFUENTE.Size = New System.Drawing.Size(117, 28)
        Me.txtFUENTE.TabIndex = 66
        '
        'Label13
        '
        ...
        Me.Name = "frmAUTOFACTURA"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "DELTA - Módulo de Autofactura"
...
#End Region
    ...
    Private Sub txtautofactura_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtnumero.TextChanged
    ...
    Private Sub txtbanco_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtbanco.GotFocus
        If Len(Trim(txtbanco.Text)) > 0 Then
            txtbanco.SelectionStart = 0
            txtbanco.SelectionLength = Len(Trim(txtbanco.Text))
        End If
    End Sub
    ...
    Private Sub txtcheque_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtcheque.GotFocus
        If Len(Trim(txtcheque.Text)) > 0 Then
            ...
            txtcheque.SelectionLength = Len(Trim(txtcheque.Text))
        End If
    ...
    Private Sub btnimprimir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btneliminar.Click
    ...
    End Sub
    Public Sub eliminarAutofactura(ByVal auxnumero As Double)
        Try
            AbrirConexion()
            strSQL = "delete from autofactura where autnumero = " & auxnumero & ""
    ...
    Function validarDATOS() As Boolean
        ...
        If Len(Trim(Me.txtnumero.Text)) <= 0 Then
            MessageBox.Show("Debe ingresar el Número de Autofactura", strSLOGAN, MessageBoxButtons.OK)
            auxBANDERA = False
            Me.txtnumero.Focus()
    ...
    Sub grabarDATOS()
        ...
        Else
            wktipo = "Exentas"
        End If
        wkfuente = Trim(Me.txtFUENTE.Text)
        wkbanco = Trim(Me.txtbanco.Text)
        wkcheque = Trim(Me.txtcheque.Text)
        Try
            AbrirConexion()
            If blnEXISTE = False Then
                strSQL = "INSERT INTO autofactura (autnumero, autfecha, autruc, autbeneficiario, autdireccion, " & _
                                      "auttelefono, autcodigo, autdescripcion,autcantidad, autprecio, " & _
                                      "auttotal, auttipo, autfuente, autbanco, autcheque) " & _
                              ...
                              "', '" & wkcheque & "')"
            Else
                strsql = "UPDATE autofactura SET " & _
                "autnumero = " & wknumero & ", " & _
                "autfecha = '" & wkfecha & "', " & _
                "autruc = '" & wkruc & "', " & _
                "autbeneficiario = '" & wkbeneficiario & " ', " & _
                "autdireccion = '" & wkdireccion & "', " & _
                "auttelefono = '" & wktelefono & "', " & _
                "autcodigo = '" & wkcodigo & "', " & _
                "autdescripcion = '" & wkdescripcion & "', " & _
                "autcantidad = " & wkcantidad & ", " & _
                "auttotal = " & wktotal & ", " & _
                "auttipo = '" & wktipo & "', " & _
                "autfuente = '" & wkfuente & "', " & _
                "autbanco = '" & wkbanco & "', " & _
                "autcheque = '" & wkcheque & "' " & _
                "WHERE autnumero = " & wknumero & ""
            End If
    ...
    Private Sub frmAUTOFACTURA_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.txtFUENTE.SelectedIndex = 0
    End Sub
    ...
    Private Sub txtFUENTE_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtFUENTE.LostFocus
        If Me.txtFUENTE.Text = "Cheque" Then
            With Me
    ...
    Private Sub txtnumero_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtnumero.LostFocus
        Call cargarAUTOFACTURA(Val(Me.txtnumero.Text))
    End Sub
    Public Function cargarAUTOFACTURA(ByVal auxnumero As Double) As Boolean
        Dim indice As Integer
        Dim wkarbfoto As String
        Try
            blnEXISTE = False
            AbrirConexion()
            strsql = "SELECT autnumero, autfecha, autruc, autbeneficiario, autdireccion, auttelefono, " & _
                            "autcodigo, autdescripcion, autcantidad, autprecio, auttotal, auttipo, autfuente, autbanco, autcheque from autofactura where autnumero = " & auxnumero & ""
            Dim myCommand As New Odbc.OdbcCommand(strsql, ca_cn)
            ...
            While myReader.Read()
                With Me
                    ...
                    If myReader.GetString(12) = "CAJA CHICA" Then
                        Me.txtFUENTE.SelectedIndex = 0
                    Else
                        With Me
                    ...
                    End If
                    .txtbanco.Text = myReader.GetString(13)
                    .txtcheque.Text = myReader.GetString(14)
                End With
                blnEXISTE = True
            End While
            myReader.Close()
    ...
    Function ultimonumero() As Integer
        ...
        Try
            AbrirConexion()
            strSQL = "SELECT max(autnumero) as maxnumero from autofactura"
            Dim myCommand As New Odbc.OdbcCommand(strSQL, ca_cn)
            Dim myReader As Odbc.OdbcDataReader = myCommand.ExecuteReader(CommandBehavior.CloseConnection)
            auxnumero = 0
            While myReader.Read()
        ...
        Catch err As Exception
            MessageBox.Show(err.Message, "Error en Asignación de Código de Autofactura", MessageBoxButtons.OK)
        End Try
    End Function
    ...
    Private Sub btnimprimir_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnimprimir.Click
        ...
        Try
            ...
            wkletras = Letras(Trim(Me.txttotal.Text))

            strSQL = "SELECT *  FROM autofactura where autnumero = " & glonumero & ";"
            ...
            With report
                .Load(wkdirectorio & "\crpAUTOFACTURA.rpt")
            ...
            With frmREPORT
                ...
                .crvimpre.SelectionFormula = "{autofactura.autnumero} = " & glonumero
                .Show()
            End With
            'Next intindice
        Catch err As Exception
